...
const CodeEditor = () => {
    ...
    return (
        <div className='main' >
            <h2 className='heading'>MHA Compiler
                {/* <ThemeSwitches /> */}
                <span>(currently supporting only javascript)</span></h2>
            ...
            <div className='boxes'>
                ...
                <div style={{ flex: 1, backgroundColor: isDark ? '#2F3129' : '#ccc', overflow: 'auto', border: isDark ? '2px solid transparent' : '2px solid #777777' }}>
